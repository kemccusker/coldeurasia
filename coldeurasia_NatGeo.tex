...
We isolate the affect of human-induced Arctic sea ice loss on the atmosphere by prescribing to an atmosphere-only model sea-ice concentration (SIC), sea-ice thickness (SIT), and sea-surface temperature (SST) boundary conditions that are an ensemble average of five historical simulations from a fully-coupled global climate model (see Methods). 
